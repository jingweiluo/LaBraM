...
def get_dataset(args):
    if args.dataset == 'TUAB':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUAB_dataset("../TUAB/processed")
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset("/data1/labram_data/tuh_eeg/tuh_eeg_events/v2.0.1/edf/processed")
